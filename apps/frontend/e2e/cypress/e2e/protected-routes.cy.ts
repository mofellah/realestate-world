...
describe('Protected Routes E2E', () => {
  ...
  it('should stay on protected route if token is valid', () => {
    ...
    const validToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI2NjY2NjY2Ni02NjY2LTY2NjYtNjY2Ni02NjY2NjY2NjY2NjYiLCJlbWFpbCI6ImFkbWluQGV4YW1wbGUuY29tIiwicm9sZXMiOlt7ImlkIjoiMjIyMjIyMjItMjIyMi0yMjIyLTIyMjItMjIyMjIyMjIyMjIyIiwibmFtZSI6IkFkbWluIn1dLCJpYXQiOjE2NzQxNDI0MDBFMDAsImV4cCI6MTY3NDE0MjYwMEUwMH0.test';
