...
describe('Registration Flow - E2E', () => {
  ...
  describe('Sad Path - Validation Errors', () => {
    ...
    it('should reject duplicate email', () => {
      ...
      cy.contains(/already.*registered|already.*exists|duplicate|conflict/i, { timeout: 5000 }).should('be.visible');
  ...
  describe('UI/UX - Form Behavior', () => {
    ...
    it('should link to login page', () => {
      cy.contains('a', /sign in|login|already have an account/i).should('exist').should('have.attr', 'href', '/login');
    });
