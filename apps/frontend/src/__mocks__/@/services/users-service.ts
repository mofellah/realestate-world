...
// Jest manual mock for '@/services/users-service'
// Mirrors the named export used throughout the app/tests
export const usersService = {
  getCurrentUser: jest.fn(),
};

// Backwards-compatible alias for tests that expect `mockUsersService`
