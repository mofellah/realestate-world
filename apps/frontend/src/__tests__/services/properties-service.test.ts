...
describe('PropertiesService', () => {
  ...
  describe('searchProperties', () => {
    ...
    it('should throw error when API call fails', async () => {
      ...
      await expect(
        propertiesService.searchProperties({ city: 'New York' })
  ...
  describe('getPropertyDetail', () => {
    ...
    it('should throw error when property not found', async () => {
      ...
      await expect(propertiesService.getPropertyDetail('nonexistent')).rejects.toThrow(
        'Not Found'
      );
    });
  });
  ...
  describe('createProperty', () => {
    ...
    it('should handle missing required fields', async () => {
      ...
      await expect(propertiesService.createProperty({})).rejects.toThrow(
  ...
  describe('updateProperty', () => {
    ...
    it('should throw error when property not found', async () => {
      ...
      await expect(
        propertiesService.updateProperty('nonexistent', {})
    ...
    it('should throw error when update validation fails', async () => {
      ...
      await expect(
        propertiesService.updateProperty('prop-1', { type: 'invalid' })
  ...
  describe('deleteProperty', () => {
    ...
    it('should throw error on unauthorized deletion', async () => {
      ...
      await expect(propertiesService.deleteProperty('prop-1')).rejects.toThrow(
        'Unauthorized'
      );
    });
  });
  ...
  describe('error handling', () => {
    it('should propagate API errors', async () => {
      ...
      await expect(propertiesService.searchProperties({})).rejects.toThrow(
        'Network Error'
      );
    });
    ...
    it('should handle timeout errors', async () => {
      ...
      await expect(propertiesService.getAllProperties()).rejects.toThrow(
        'Request timeout'
      );
    });
