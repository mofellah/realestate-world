...
describe('ListingsService', () => {
  ...
  describe('createListing', () => {
    ...
    it('should throw error when listing creation fails', async () => {
      ...
      await expect(listingsService.createListing(listingData)).rejects.toThrow(
        'Validation Error'
      );
    });
    ...
    it('should handle missing required fields', async () => {
      ...
      await expect(listingsService.createListing({})).rejects.toThrow(
  ...
  describe('getListing', () => {
    ...
    it('should throw error when listing not found', async () => {
      ...
      await expect(listingsService.getListing('nonexistent')).rejects.toThrow(
        'Listing not found'
      );
    });
  });
  ...
  describe('deleteListing', () => {
    ...
    it('should throw error on unauthorized deletion', async () => {
      ...
      await expect(listingsService.deleteListing('listing-1')).rejects.toThrow(
        'Unauthorized'
      );
    });
  });
