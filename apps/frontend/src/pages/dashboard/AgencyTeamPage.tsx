        ...
        {showInviteForm && (
          <div className="bg-white rounded-lg shadow p-6 mb-6">
            ...
            <div className="flex space-x-4">
              ...
              />
              <button onClick={handleInvite} className="bg-blue-600 text-white px-6 py-2 rounded-lg hover:bg-blue-700">
                Send Invite
              </button>
              <button
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Active Listings</th>
                ...
                <tr key={agent.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                      agent.role === 'manager' ? 'bg-purple-100 text-purple-800' : 'bg-blue-100 text-blue-800'
                    }`}>
                      {agent.role}
                    </span>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{agent.activeListings}</td>
