...
describe('Protected Routes E2E', () => {
  ...
  it('should allow access to dashboard with valid token in localStorage', () => {
    ...
    cy.window().then((win) => {
      ...
      const mockToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLTEyMyIsImVtYWlsIjoiYWRtaW5AZXhhbXBsZS5jb20iLCJyb2xlcyI6W3sicm9sZU5hbWUiOiJhZG1pbiJ9XSwiaWF0IjoxNzA2MDAwMDAwLCJleHAiOjk5OTk5OTk5OTl9';
  ...
  it('should clear token and redirect on 401 response', () => {
    cy.window().then((win) => {
      ...
      const expiredToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLTEyMyIsImVtYWlsIjoiYWRtaW5AZXhhbXBsZS5jb20iLCJleHAiOjE3MDAwMDAwMDB9';
