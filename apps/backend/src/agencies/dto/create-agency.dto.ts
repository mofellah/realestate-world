...
export class CreateAgencyDto {
  ...
  @ApiPropertyOptional({ description: 'Agency tier', enum: ['basic', 'professional', 'enterprise'] })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Maximum number of active listings', minimum: 1, maximum: 10000 })
  @IsOptional()
  @IsInt()
  @Min(1)
  @Max(10000)
