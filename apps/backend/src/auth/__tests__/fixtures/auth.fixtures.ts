...
export const mockLoginResponse: LoginResponse = {
  accessToken:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLTEyMyIsImVtYWlsIjoiYWRtaW5AZXhhbXBsZS5jb20iLCJyb2xlcyI6WyJhZG1pbiJdLCJwZXJtaXNzaW9ucyI6WyJ1c2VyczpyZWFkIiwidXNlcnM6d3JpdGUiXSwiY29ycmVsYXRpb25JZCI6InRyYWNlLTEyMyIsImlhdCI6MTczMzY4MDAwMCwiZXhwIjoxNzMzNjgwOTAwfQ.test-signature",
  refreshToken:
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ1c2VyLTEyMyIsImVtYWlsIjoiYWRtaW5AZXhhbXBsZS5jb20iLCJyb2xlcyI6WyJhZG1pbiJdLCJwZXJtaXNzaW9ucyI6WyJ1c2VyczpyZWFkIiwidXNlcnM6d3JpdGUiXSwiY29ycmVsYXRpb25JZCI6InRyYWNlLTEyMyIsImlhdCI6MTczMzY4MDAwMCwiZXhwIjoxNzM0Mjg0ODAwfQ.test-signature",
  expiresIn: 900,
  user: {
    id: "user-123",
    email: "admin@example.com",
